"""Provides basic train and validation loops"""
...
def classification_loop(
    ...
    validation_loss_avg = validation_loss_sum / num_batches
    validation_accuracy = validation_correct_pred / num_validation_data
